          ...
          {authView === "forgot" ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center whitespace-nowrap shrink-0 py-3.5 rounded-full gradient-cta text-sm font-bold uppercase tracking-[0.1em] shadow-[0_0_30px_rgba(182,160,255,0.15)] mt-2 transition-transform hover:scale-[1.02]"
                >
                  Send Recovery Link
                </button>
              </form>
