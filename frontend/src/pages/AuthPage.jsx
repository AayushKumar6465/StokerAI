  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (authView === "signin") {
        ...
        toast.success("Recovery protocol initiated (demo)");
      }
    } catch (error) {
      toast.error(
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center whitespace-nowrap shrink-0 py-3.5 rounded-full gradient-cta text-sm font-bold uppercase tracking-[0.1em] shadow-[0_0_30px_rgba(182,160,255,0.15)] mt-2 transition-transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <>
              ...
              <p className="text-sm text-on-surface-variant/60 mb-9">
                {authView === "signin"
                  ...
                  : "Establish your neural signature to begin."}
              </p>
              ...
              <p className="text-center text-[13px] text-on-surface-variant/40 mt-8">
                ...
                <button
                  ...
                  className="text-primary/80 font-medium hover:text-primary transition-colors"
                >
                  {authView === "signin" ? "Request Invitation" : "Initiate Sync"}
                </button>
              </p>
            </>
          )}
